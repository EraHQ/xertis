export default function UserDashboard() {
    return (
      <div className="w-full h-screen bg-[#0f1728] flex overflow-hidden">
        ...
        {/* Main Content */}
        <div className="flex-1 bg-white flex flex-col p-8 overflow-auto">
          {/* Header */}
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="bg-[#497bff] text-white px-4 py-2 rounded">
                Add Certificate
              </button>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="flex items-center gap-2 bg-[#497bff] text-white px-4 py-2 rounded">
              Add Certificate
            </button>
          </div>
